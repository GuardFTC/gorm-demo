...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.Grade = field.NewInt32(tableName, "grade")
	_student.Class = field.NewInt32(tableName, "class")
...
type student struct {
	...
	Age        field.Int32  // 年龄
	Grade      field.Int32  // 年级编号
	Class      field.Int32  // 班级编号
...
func (s *student) updateTableName(table string) *student {
	...
	s.Grade = field.NewInt32(table, "grade")
	s.Class = field.NewInt32(table, "class")
