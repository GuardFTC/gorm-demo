...
func newTeacher(db *gorm.DB, opts ...gen.DOOption) teacher {
	...
	_teacher.ID = field.NewInt32(tableName, "id")
	_teacher.Name = field.NewString(tableName, "name")
	_teacher.Email = field.NewString(tableName, "email")
	_teacher.Age = field.NewInt32(tableName, "age")
	_teacher.Subject = field.NewString(tableName, "subject")
